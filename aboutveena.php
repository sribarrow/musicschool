...
<div class="container">               
  <ol class="breadcrumb">
    <li class="active"><a href="aboutveena.php">About Veena</a></li>       
  </ol>
    <div id="pagecontent"> 
        <div class="col-md-12" id="left-pane"><img id="focal-pic" alt="Lalitha Mahadevan| Carnatic Music School | Classical instrument | veena " src="./img/saraswativeena.gif"></div>
        <div class="col-md-12">
         <h2>Know Your Veena</h2>  
...
<div id="collapse1" class="panel-collapse collapse in">
    <div class="panel-body"><p><strong>For centuries over, dating back to vedic times, veena is considered as a divine instrument and playing veena is considered to be a yoga . "All emotions, feelings and rasas (nine emotions) are evolved from this instrument" says mythology. Yagjavalkya Maharishi observed that:</strong><br />
        <pre>Veena vadana tatvagjah Srutijaati Visarathah |
    Talagjascha$prayatnena mokshamargam sa gachchati ||</pre></p>
    <p>(In short, it means, salvation or liberation can be attained effortlessly 
    ...
    mental and physical efforts. </p>
    <p>Veena, the traditional instrument of India is also known as Saraswati Veena
    ...
    of India.</p>
    <p>Veena instruments developed more like a tree which is branching out into 
    ...
    bamboo, and wood and coconut shells.</p>
    <p>The Saraswati Veena is nearly about four feet in length and consists of a big 
    ...
    Sangeeta Ratnakara calls it Ekatantri Veena.</p>
    <p>Each physical portion of the veena is said to be the seat in which subtle aspects
    ...
    and its impressive designing.</p></div> <!--panel-body-->
    </div><!--collapse1-->
</div> <!--panel-default-->
...
<div class="panel-body"><p>The Veena is held tilted slightly away from the performer. One has to sit cross legged and place the Veena on the lap. A small gourd is placed on the left thigh of the player and the resonator is rested on the ground while it is played. The left arm of the Veena player comes curving from below the fret board and 
...
often used to relax the mind and help in meditation.</p></div> <!-- panel-body -->
</div><!-- collapse2-->
</div><!--panel-default-->
...
<div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        ...
        The origin of nadam or musical resonance</a>
      </h4>
    </div>
<div id="collapse3" class="panel-collapse collapse">
    <div class="panel-body"><p>According to astronomy, in Libra constellation there is a star called Swathi, also 
    known as Alpha Cygnus. This constellation represents a picture of Lyre or 
    the veena.</p>
    <p>Many decades ago, scientists and philosophers detected a hissing noise coming 
    out of this constellation. This is nothing but nadha or musical resonance that 
    pervades the universe. This not only pervades the universe but also the human body
    to be discovered by one within oneself. Therefore veena is a very spiritual 
    instrument meant for nada yoga. This is meant for musical meditation. 
    Our human body is comparable to veena instrument. Both these veena is to 
    attain salvation and soul liberation.</p></div> <!-- panel-body -->
</div><!-- collapse3 -->
</div> <!-- panel-default -->
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        ...
        Physical and spiritual similarities between veena and the human body</a>
      </h4>
    </div>
<div id="collapse4" class="panel-collapse collapse">
    <div class="panel-body"><p>There are lot of physical and spiritual  similarities between veena and 
    the human body.Veena has head like human being which is called Kudam. Veena dhandi is 
    the trunk of the veena. It is like the spinal cord for human being. A trunk of veena 
    has 24 frets and like 24 vertebrae of a spinal cord. These vertebrae is divided into 
    cervical, dorsal and lumber. The cervical consists of 7 vertebrae analogous to 
    7 frets placed in the neck region of the veena. Dorsal consist of 12 vertebrae and 
    it comes in the middle of the trunk of veena. Lumber consist of 5 vertebrae and 
    it is at the base of the trunk of veena. These frets are set  and held in bee wax  and 
    not movable. The veena dhandi is extends to simha mukha or dragon head. This is 
    a curve which is also there in human spinal cord.</p>
    <p>Veena is made of wood from Jackfruit tree. The wood is cut out of Jackfuit tree and seasoned and only then the wood grain absorb the musical resonance. When veena 
    is made out of pure Jackfruit tree wood, the veena sounds very good and natural. 
    So, this “Kudam” is full of musical resonance.</p>
    <p>The first string is tuned to D sharp, the 2nd to A sharp and 3rd string to D sharp 
    and 4th to A sharp. (SA PA SA PA). Thalam strings are called drone or supportive 
    strings and it used to keep the rhythmic cycles of different beats.
    ...
    general had Veena as the guiding star for its development. </p>
    <p>Sarangadeva has beautifully elaborated the divinity of veena as:
    <pre>Darsana sparsane chasya bhoga svargapavargade |
    ...
    Sarvadevamayi tasmad veeneyam sarvamangala ||</pre>
    </p>
    <p>(That is, by seeing and touching the veena, one attains the sacred 
    ...
    of divine blessings, benediction and auspiciousness).</p>
    <p>The music of veena has been glorified by the tamil saivite saints in various 
    ...
    He says:</p><p>
    <pre>Maasi veenaiyum maalai mathiyamum
    Veesu thendralum, veengila venilum
    Moosu vandarai poygayum pondrade
    Eesan enthai inaiyadi neezhale.</pre>
    ...
    singing along with veena improves the quality of the voice.</p>
    <p>In conclusion, veena playing is an yoga by itself, which can bestow happiness
    ...
    veena and have looked upon the veena practice as means to an end.</p></div> <!-- panel-body -->
</div><!-- collapse4-->
</div><!-- panel-default -->
<div class="panel panel-default">
    <div class="panel-heading">
      <h4 class="panel-title">
        ...
        Well known Vainikas (veena players)</a>
      </h4>
    </div>
<div id="collapse5" class="panel-collapse collapse">
<div class="panel-body"><ul  class="list-group">
    <li class="list-group-item"><img src="img/ks_guru.png" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;Smt. Kalpakam Swaminathan</li>
    <li class="list-group-item"><img src="img/egayathri1.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;E.Gayathri</li>
    <li class="list-group-item"><img src="img/doraisamyiyengar.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;Doraiswamy Iyengar</li>
    <li class="list-group-item"> <img src="img/jayanthikumaresh.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;Jayanthi Kumaresh</li>
    <li class="list-group-item">Pudukotai R. K Murthy</li>
    <!--                        <li class="list-group-item"><img src="img/chittibabu.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;Chitti Babu</li>-->
    <li class="list-group-item"><img src="img/rajeswari_padmanabhan.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;Rajeshwari Padmanabhan</li>
    <li class="list-group-item"><img src="img/nmuralikrishnan.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;N. Muralikrishnan</li>
    <li class="list-group-item"><img src="img/ravikiran.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;N. Ravikiran</li>
    <li class="list-group-item"><img src="img/sbalachander.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;S. Balachander</li>
    <li class="list-group-item">S.V. Venkateshiah</li>
    <li class="list-group-item"><img src="img/Veena%20Dhanammal.jpg" alt="Vainikas" style="width:200px;height:100px;margin-bottom:5px;"> &nbsp;&nbsp;Veena Dhanammal</li>
    <li class="list-group-item">Veena Venkatagiriappa</li>
    <li class="list-group-item">Veena Sheshann</li></ul></div><!--panel-body-->
    </div><!--collapse5-->
</div><!--panel-default-->
        </div><!--accordion-->
    </div>
