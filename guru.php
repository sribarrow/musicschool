...
<div class="container">               
  <ol class="breadcrumb">
    <li class="active"><a href="guru.php">Sri Guru</a></li>       
  </ol>
    <div id="pagecontent"> 
        <div class="col-md-4" id="left-pane"><img id="focal-pic" alt="Lalitha Mahadevan| Carnatic Music School | Classical instrument | veena " src="./img/ks_guru.png"></div>
        <div class="col-md-8">
        <div id="grey-box">
            <p style="color:red;">Online edition of India's National Newspaper, The Hindu</p>
            <p style="color:blue;">Friday, Jul 27, 2007 <br />
            <strong>Gifted, self-effacing</strong></p>
        </div>
 
<p>
    <cite style="font-size:.7em;">GOWRI RAMNARAYAN</cite> <br /><span class="center-text green"><strong>Acknowledging her rich repertoire, Musiri called her &#39;Dikshitarini.&#39;</strong></span><br />
</p>
 <p class="center-text"><span >Photo: N. Sridharan.</span> <br /></p>
...
<p style="background-color:#E1F5A9;"><cite>
